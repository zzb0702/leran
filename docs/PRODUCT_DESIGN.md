...
**WordReel 是一个「视频即语料」的英语学习工作台**：上传无字幕英语视频 → 得到可编辑的中英双语字幕 → 把句子里的真实用词沉淀成可复习的单词卡。
...
**市场空档已验证：** 高星项目分成三条互不打通的线——字幕流水线（pyvideotrans / VideoLingo）、挖矿制卡（asbplayer / mpvacious）、学习播放器（LLPlayer）。几乎没人把「无字幕 → 双语工作台 → 内置 SRS」做成同一 Web 闭环。WordReel 的双核定位成立。
